...
<main>
    <div class="about-hero__container">
        <div class="text text-about">
            ...
            <h3 class="title">Edit Order</h3>
        </div>
        <div class="banner">
            <a class="home" href="/">Home</a>
            <span>|</span>
            <h1 class="page">Edit Order</h1>
        </div>
    </div>
  ...
  <div class="submit-message-container">
                ...
                <h4>Your order has been edited successfully!</h4>
    </div>
    @endif  
      
            <form class="contact-inputs" action="{{ url('editOrder', $order) }}" method="POST">
                @csrf
                @method('put')
                ...
                <div class="container-input">
                        ...
                        <label for="">Room Number</label>
                            ...
                            <option value="{{$order->room_id}}" selected>{{$order->room_id}}</option>
                    ...
                    <div class="container-input">
                        <div class="input-order">
                            ...
                            <textarea type="text" name="description">{{$order->description}}</textarea>
                            <div class="input-error"></div>
                        </div>
                    </div>
